...
fig1.animate(centerCallback)

# fig1.animate('sphere1', 'center', centerCallback,
#              'sphere1', 'radius', radiusCallback, time=20) # Los callbacks tienen que tener información de tiempo para poder hacer visualizaciones en tiempo real.
