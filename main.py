...
fig1.add_sphere(center=linear([[0.2, 0, 0], [0.3, 0.3, 0]], 3, 60), radius=linear([[0.2], [0.3]], 1, 60), color='blue', opacity=0.8, contours='latlon')
fig1.add_sphere(center=[0.2, 0, 0.3], radius=linear([[0.1], [0.2]], 2, 60), color='blue', opacity=0.6, contours='latlon')
